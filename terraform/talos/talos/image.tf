# terraform/talos/talos/image.tf
locals {
...
# HTTP data sources are evaluated at plan time, making the schematic ID
# available as a for_each key for the download_file resource below.
